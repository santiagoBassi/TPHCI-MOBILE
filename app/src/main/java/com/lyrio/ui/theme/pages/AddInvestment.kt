    ...
    Column(
        ...
        AppWindow {
            Column(
                ...
                Text("¿Cuánto querés invertir?", style = MaterialTheme.typography.titleLarge, fontWeight = FontWeight.SemiBold, color = Color.Black)
                Text("Saldo disponible: $$availableBalance", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.SemiBold, color = Color.Gray,
                ...
                AppButton(text = "Invertir", onClick = { /*TODO*/ }, modifier = Modifier.fillMaxWidth(0.7f))
            }
        }
    }
